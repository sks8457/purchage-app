  ...
  return (
    <>
      <div className="bg-black p-4 w-full flex justify-center items-center ">
        <p className="text-green-400 font-inter text-2xl font-bold  ">
          It's Shopping Time
        </p>
      </div>
      <div className="flex justify-around items-center">
        ...
        <div className="flex flex-row items-center">
          <div className="flex flex-row items-center">
            ...
            <p className=" font-inter text-purple-500 font-medium tracking-normal leading-none text-center mr-2">
              Wish List
            </p>
          </div>
          <div
          ...
          >
            ...
            <p className=" font-inter text-purple-500 font-medium tracking-normal leading-none text-center ">
              Shopping bag
            </p>
            <div>
          ...
          <div className="flex flex-row items-center cursor-pointer pl-4">
            ...
            <div onClick={() => dispatch(logout())}>
              <Tooltip content="SignOut" placement="bottom">
                <p className="font-inter text-purple-500 font-medium tracking-normal leading-none">
